...
public class FighterChestplate extends CustomItem {


    public FighterChestplate() {
        super(Material.LEATHER_CHESTPLATE, "FighterChestplate");
    ...
    public String getName() {
        return "&4Chainmeal Strengthened Leather Hide";
    }
