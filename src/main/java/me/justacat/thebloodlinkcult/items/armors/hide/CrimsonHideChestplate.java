...
public class CrimsonHideChestplate extends CustomItem {
    public CrimsonHideChestplate() {
        super(Material.LEATHER_CHESTPLATE, "CrimsonHideChestplate");
    ...
    public String getName() {
        return "&4Crimson Hide Chestplate";
    }
