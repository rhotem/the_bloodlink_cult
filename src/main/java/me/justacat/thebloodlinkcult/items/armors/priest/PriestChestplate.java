...
public class PriestChestplate extends CustomItem {


    public PriestChestplate() {
        super(Material.LEATHER_CHESTPLATE, "PriestChestplate");
    ...
    public String getName() {
        return "&4Bloodlink Priest Chestplate";
    }
